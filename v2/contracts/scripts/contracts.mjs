...
const generated = path.join(root, 'v2/contracts/src/generated');
...
function run(output) {
  const result = spawnSync('cargo', ['run', '--quiet', '--manifest-path', 'v2/core/Cargo.toml', '--example', 'export_contracts', '--features', 'export-types'], {
    cwd: root,
