  ...
  !function() {
      ...
      var e = Math.abs
        ...
        , l = function(t) {
          ...
          function(t) {
              for (var n = t.order, r = t.points, i = y.align(r, {
                  p1: r[0],
                  p2: r[n]
              }), o = 0; o < i.length; o++)
                  if (e(i[o].y) > 1e-4)
      ...
      l.prototype = {
          ...
          toSVG: function(t) {
              if (this._3d)
                  return !1;
              for (var n = this.points, r = n[0].x, i = n[0].y, e = ["M", r, i, 2 === this.order ? "Q" : "C"], o = 1, s = n.length; s > o; o++)
                  e.push(n[o].x),
                  e.push(n[o].y);
              return e.join(" ")
          },
          update: function() {
              this.dpoints = [];
              for (var t = this.points, n = t.length, r = n - 1; n > 1; n--,
              r--) {
                  for (var i, e = [], o = 0; r > o; o++)
                      i = {
                          x: r * (t[o + 1].x - t[o].x),
                          y: r * (t[o + 1].y - t[o].y)
                      },
          ...
          getLUT: function(t) {
              ...
              this._lut = [];
              for (var n = 0; t >= n; n++)
                  this._lut.push(this.compute(n / t));
              return this._lut
          },
          on: function(t, n) {
              n = n || 5;
          ...
          project: function(t) {
              ...
              var a, s, f, c, h = (o - 1) / r, x = (o + 1) / r, p = .1 / r;
              for (e += 1,
              s = h,
              a = s; x + p > s; s += p)
                  f = this.compute(s),
          ...
          compute: function(t) {
              ...
              if (1 === this.order)
                  ...
                  f;
              if (this.order < 4) {
                  var i, e, o, s = r * r, u = t * t, a = 0;
                  2 === this.order ? (n = [n[0], n[1], n[2], x],
                  i = s,
                  e = r * t * 2,
                  o = u) : 3 === this.order && (i = s * r,
                  e = s * t * 3,
                  o = r * u * 3,
                  a = t * u);
                  var f = {
          ...
          raise: function() {
              for (var t, n, r, i = this.points, e = [i[0]], o = i.length, t = 1; o > t; t++)
                  n = i[t],
                  r = i[t - 1],
                  e[t] = {
                      x: (o - t) / o * n.x + t / o * r.x,
          ...
          derivative: function(t) {
              var n, r, i = 1 - t, e = 0, o = this.dpoints[0];
              2 === this.order && (o = [o[0], o[1], x],
              n = i,
              r = t),
              3 === this.order && (n = i * i,
              r = i * t * 2,
          ...
          hull: function(t) {
              var n, r = this.points, i = [], e = [], o = 0, s = 0, u = 0;
              for (e[o++] = r[0],
              e[o++] = r[1],
              e[o++] = r[2],
              3 === this.order && (e[o++] = r[3]); r.length > 1; ) {
                  for (i = [],
                  s = 0,
                  u = r.length - 1; u > s; s++)
                      n = y.lerp(t, r[s], r[s + 1]),
                      e[o++] = n,
                      i.push(n);
                  r = i
              }
          ...
          split: function(t, n) {
              ...
              if (i.left._t1 = y.map(0, 0, 1, this._t1, this._t2),
          ...
          extrema: function() {
              ...
              return r.forEach(function(r) {
                  ...
                  i[r] = y.droots(t),
                  3 === this.order && (t = this.dpoints[1].map(n),
                  i[r] = i[r].concat(y.droots(t))),
          ...
          reduce: function() {
              var t, n, r = 0, i = 0, o = .01, s = [], u = [], a = this.extrema().values;
              for (-1 === a.indexOf(0) && (a = [0].concat(a)),
          ...
          scale: function(t) {
              ...
              .bind(this)),
              new l(f)) : ([0, 1].forEach(function(t) {
                  if (2 !== this.order || !t) {
                      var r = f[t * n]
                        , i = this.derivative(t)
                        , e = {
          ...
          outline: function(t, n, r, i) {
              ...
              var o, s = this.reduce(), u = s.length, a = [], f = [], c = 0, h = this.length(), x = "undefined" != typeof r && "undefined" != typeof i;
              s.forEach(function(o) {
                  _ = o.length(),
                  x ? (a.push(o.scale(e(t, r, h, c, _))),
                  f.push(o.scale(e(-n, -i, h, c, _)))) : (a.push(o.scale(t)),
                  f.push(o.scale(-n))),
                  c += _
              }),
              f = f.map(function(t) {
          ...
          intersects: function(t, n) {
              return t ? t.p1 && t.p2 ? this.lineIntersects(t) : (t instanceof l && (t = t.reduce()),
              this.curveintersects(this.reduce(), t, n)) : this.selfintersects(n)
          },
          ...
          selfintersects: function(t) {
              var n, r, i, e, o = this.reduce(), s = o.length - 2, u = [];
              for (n = 0; s > n; n++)
                  i = o.slice(n, n + 1),
                  e = o.slice(n + 2),
          ...
          _iterate: function(t, n) {
              ...
              do {
                  r = 0,
                  e = 1;
                  var o, s, f, c, h, x = this.get(i), p = !1, l = !1, v = e, d = 1, m = 0;
                  do {
                      l = p,
                      c = f,
                      v = (i + e) / 2,
  ...
  !function() {
      var n = Math.abs
        ...
        , v = {
          ...
          length: function(t) {
              var n, r, i = .5, e = 0, o = v.Tvalues.length;
              for (n = 0; o > n; n++)
                  r = i * v.Tvalues[n] + i,
                  e += v.Cvalues[n] * v.arcfn(r, t);
              return i * e
          },
          ...
          roots: function(t, n) {
              ...
              var g, d, z, b, _, w = e[0].y, E = e[1].y, S = e[2].y, M = e[3].y, y = -w + 3 * E - 3 * S + M, a = (3 * w - 6 * E + 3 * S) / y, c = (-3 * w + 3 * E) / y, x = w / y, e = (3 * c - a * a) / 3, k = e / 3, O = (2 * a * a * a - 9 * a * c + 27 * x) / 27, T = O / 2, N = T * T + k * k * k;
              if (0 > N) {
                  var j = -e / 3
                    , I = j * j * j
                    , A = u(I)
                    ...
                    , U = f(A)
                    , B = 2 * U;
                  return z = B * i(q / 3) - a / 3,
                  b = B * i((q + h) / 3) - a / 3,
                  _ = B * i((q + 2 * h) / 3) - a / 3,
                  [z, b, _].filter(s)
              }
              if (0 === N)
                  return g = 0 > T ? f(-T) : -f(T),
                  z = 2 * g - a / 3,
                  b = -g - a / 3,
                  [z, b].filter(s);
              var G = u(N);
          ...
          bboxoverlap: function(t, r) {
              var i, e, o, s, u, a = ["x", "y"], f = a.length;
              for (i = 0; f > i; i++)
                  if (e = a[i],
                  o = t[e].mid,
                  s = r[e].mid,
          ...
          pairiteration: function(t, n, r) {
              ...
              if (i.x.size + i.y.size < s && e.x.size + e.y.size < s)
                  return [(o * (t._t1 + t._t2) / 2 | 0) / o + "/" + (o * (n._t1 + n._t2) / 2 | 0) / o];
              var u = t.split(.5)
                , a = n.split(.5)
                , f = [{
                  left: u.left,
          ...
          getccenter: function(t, n, r) {
              var o, u = n.x - t.x, a = n.y - t.y, f = r.x - n.x, c = r.y - n.y, y = u * i(x) - a * e(x), p = u * e(x) + a * i(x), l = f * i(x) - c * e(x), d = f * e(x) + c * i(x), m = (t.x + n.x) / 2, g = (t.y + n.y) / 2, z = (n.x + r.x) / 2, b = (n.y + r.y) / 2, _ = m + y, w = g + p, E = z + l, S = b + d, M = v.lli8(m, g, _, w, z, b, E, S), k = v.dist(M, t), O = s(t.y - M.y, t.x - M.x), T = s(n.y - M.y, n.x - M.x), N = s(r.y - M.y, r.x - M.x);
              return N > O ? ((O > T || T > N) && (O += h),
              O > N && (o = N,
              N = O,
              O = o)) : T > N && O > T ? (o = N,
              N = O,
...
, function(t, n, r) {
  ...
  !function() {
      ...
      i.prototype = {
          ...
          bbox: function e() {
              for (var t = this.curves, e = t[0].bbox(), r = 1; r < t.length; r++)
                  n.expandbox(e, t[r].bbox());
              return e
          },
          offset: function o(t) {
              var o = [];
